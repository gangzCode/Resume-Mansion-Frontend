                    ...
                    <div className='container'>
                        <div className='home_continer_main_one'>
                            <div className='price_card_conetnt_hero'>
                                <h1 className='price_card_conetnt_hero_topic'>Land 3X More Interviews with a Winning Resume!</h1>
                                <p className='price_card_conetnt_hero_pera'>Get hired for your dream job faster with our Certified Professional Resume Writing Services.</p>
                            </div>
