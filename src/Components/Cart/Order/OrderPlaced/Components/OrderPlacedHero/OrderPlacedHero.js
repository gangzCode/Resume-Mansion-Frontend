                ...
                <div className="OrderPlacedHeroContiner_sub_two_status">
                  <div>
                    <svg
                      ...
                      fill="none"
                    >
                      <g clip-path="url(#clip0_40000010_8599)">
                        <path
                      ...
                      <defs>
                        <clipPath id="clip0_40000010_8599">
                  ...
                  <div>
                    <svg
                      ...
                      fill="none"
                    >
                      <g clip-path="url(#clip0_40000010_8603)">
                        <path
                          d="M7.13353 3.0752C6.2236 3.45185 5.39675 4.00402 4.7002 4.7002"
                          stroke="#9AB2A8"
                        ...
                        />
                        <path
                          d="M3.075 7.1333C2.69713 8.04188 2.50175 9.01594 2.5 9.99997"
                          stroke="#9AB2A8"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M3.0752 12.8667C3.45185 13.7766 4.00402 14.6035 4.7002 15.3"
                          stroke="#9AB2A8"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M7.13379 16.9248C8.04237 17.3027 9.01643 17.4981 10.0005 17.4998"
                          stroke="#9AB2A8"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M12.8662 16.9248C13.7761 16.5481 14.603 15.996 15.2995 15.2998"
                          stroke="#9AB2A8"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M16.9248 12.8667C17.3027 11.9581 17.4981 10.984 17.4998 10"
                          stroke="#9AB2A8"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M16.9248 7.13353C16.5481 6.2236 15.996 5.39675 15.2998 4.7002"
                          stroke="#9AB2A8"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M12.8667 3.075C11.9581 2.69713 10.984 2.50175 10 2.5"
                          stroke="#9AB2A8"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                      ...
                      <defs>
                        <clipPath id="clip0_40000010_8603">
                          <rect width="20" height="20" fill="white" />
                        </clipPath>
                      </defs>
                    </svg>
