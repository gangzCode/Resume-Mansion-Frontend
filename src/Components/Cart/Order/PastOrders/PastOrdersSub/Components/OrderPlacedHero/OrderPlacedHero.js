            ...
            <div className='continer_main_box'>
                <div className='container'>
                    <div className='OrderPlacedHeroContiner_sub'>
                        <div className='btn_add_new'> <button className='hero_back_btn_ordeer' onClick={() => (window.location.href = '/previousOrders')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                <g clip-path="url(#clip0_220_20547)">
                                    <path d="M19 12.5H5" stroke="#0D5438" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11 18.5L5 12.5" stroke="#0D5438" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11 6.5L5 12.5" stroke="#0D5438" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                        ...
                        <div className='OrderPlacedHeroContiner_sub_two'>
                            <p className='OrderPlacedHeroContiner_sub_two_topic'>order status #008</p>
                            <div className='OrderPlacedHeroContiner_sub_two_status_continer'>
                                ...
                                <div className='OrderPlacedHeroContiner_sub_two_status_title_con'>
                                    <p className='OrderPlacedHeroContiner_sub_two_status_title'>Order placed</p>
                                    <p className='OrderPlacedHeroContiner_sub_two_status_title'>Submit requirements</p>
                                    <p className='OrderPlacedHeroContiner_sub_two_status_title'>Writing in progress</p>
                                    <p className='OrderPlacedHeroContiner_sub_two_status_title'>Delivered</p>
                                </div>
