...
function PriceContent() {
  ...
  const handleCustomClick = () => {
    const topic = "Custom Career Suite"; 
    const price = "100";
    localStorage.setItem('selectedPrice', price);
    localStorage.setItem('selectedTopic', topic);
    window.location.href = '/itemCart';
          ...
          <div className='container'>
            <div className='home_continer_main_one'>
              <div className='price_card_container'>
                <div className='price_card_update'>
                  <div className='pric_card_content_topic'>
                    <p className='price_card_topic'>Career Starter</p>
                    <p className='price_card_pera_update'>Entry-level resume with keywords, optimized for ATS & review-ready.</p>
                  </div>
                  <div className='pric_card_content'>
                    <p className='price_card_name_update'>Investment</p>
                    <p className='price_card_price'>$169</p>
                  </div>
                  <button className='price_card_btn' onClick={handleCareerClick}>Choose</button>
                ...
                <div className='price_card_update'>
                  <div className='pric_card_content_topic'>
                    ...
                    <p className='price_card_pera_update'>Resume & cover letter combo for enhanced visibility and impact.</p>
                  </div>
                  <div className='pric_card_content'>
                  ...
                  <button className='price_card_btn' onClick={handleProfessionalClick}>Choose</button>
                  <div className='price_card_item_continer'>
                    <p className='price_card_sub'>What You’ll Get</p>
                    <p className='price_card_item'>
                      <div>
                ...
                <div className='price_card_update'>
                  <div className='pric_card_content_topic'>
                    ...
                    <p className='price_card_pera_update'>Put together a memorable job application with a professional resume, cover letter, and LinkedIn profile.</p>
                  </div>
                  ...
                  <button className='price_card_btn' onClick={handleExecutiveClick}>Choose</button>
                  <div className='price_card_item_continer'>
                    <p className='price_card_sub'>What You’ll Get</p>
                    <p className='price_card_item'>
                      <div>
              ...
              <div className='sub_card_price_update'>
                <div >
                  ...
                  <p className='pera_sub_price_update'>Tailored solutions for multiple resumes, cover letters, and profiles.</p></div>
                <div className='lft_clm'>
                  ...
                  <button className='sub_card_btn_price' onClick={handleCustomClick}>Choose</button>
                </div>
              </div>
